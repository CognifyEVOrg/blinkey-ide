...
- **Description**: Updated to "Blinkey AI-Powered Arduino IDE - An agentic IDE for embedded computers"
- **Repository**: Updated to point to `https://github.com/CognifyEVOrg/arduino-ide.git`
- **Author**: Changed from "Arduino SA" to "Blinkey"
...
- **Author**: Changed from "Arduino SA" to "Blinkey"
- **Description**: Updated to "Blinkey AI-Powered IDE"
